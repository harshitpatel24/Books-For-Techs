<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Mahajan.aspx.cs" Inherits="_Default" %>
...
<td>
     ...
     <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
         ...
         SelectCommand="SELECT * FROM [add_book] WHERE ([pub_name] = @pub_name)">
         <SelectParameters>
             <asp:Parameter DefaultValue="Mahajan" Name="pub_name" Type="String" />
         </SelectParameters>
     </asp:SqlDataSource>
    </td>
</tr>
